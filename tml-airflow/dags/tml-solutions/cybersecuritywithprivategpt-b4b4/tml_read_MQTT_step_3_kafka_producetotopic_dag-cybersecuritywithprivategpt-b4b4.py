...
default_args = {
  ...
  'mqtt_broker' : 'd55e5ee8d0c34f3c9084781c02dd6c78.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-b4b4", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-b4b4"], schedule=None,catchup=False)
